...
(customer_id, old_city, new_city, old_birth_date, new_birth_date,
 old_membership_grade, new_membership_grade, changed_at)
VALUES
    (1, 'Busan',   'Seoul',   '2004-03-12', '2004-03-12', 'Silver', 'Gold',   '2026-05-03 10:00:00'),
    (2, 'Seoul',   'Busan',   '1998-07-21', '1998-07-21', 'Bronze', 'Silver', '2026-05-04 10:00:00'),
    (3, 'Daegu',   'Incheon', '1995-11-05', '1995-11-05', 'Silver', 'Bronze', '2026-05-02 10:00:00'),
    (4, 'Incheon', 'Daegu',   '2001-02-17', '2001-02-17', 'Silver', 'Gold',   '2026-05-03 10:00:00'),
    (5, 'Seoul',   'Daejeon', '1989-09-30', '1989-09-30', 'Bronze', 'Silver', '2026-05-04 10:00:00'),
    (6, 'Busan',   'Gwangju', '1992-12-14', '1992-12-14', 'Silver', 'Gold',   '2026-05-04 10:00:00'),
    (7, 'Daejeon', 'Seoul',   '1985-04-08', '1985-04-08', 'Bronze', 'Bronze', '2026-05-05 10:00:00'),
    (8, 'Seoul',   'Suwon',   '2006-06-25', '2006-06-25', 'Bronze', 'Silver', '2026-05-05 10:00:00'),
    (9, 'Gwangju', 'Ulsan',   '1979-01-19', '1979-01-19', 'Silver', 'Gold',   '2026-05-06 10:00:00'),
    (10, 'Busan',  'Jeju',    '2000-10-03', '2000-10-03', 'Silver', 'Bronze', '2026-05-06 10:00:00');
